;;; misty-lavender-theme.el --- Theme

;; Copyright (C) 2023 , Mistyhands 
...
;;; Commentary:
;;; misty-lavender theme created by Mistyhands in 2023

;;; Code:

(deftheme misty-lavender)
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(region ((,class (:background ,selection :foreground ,bg1))))
...
(provide-theme 'misty-lavender)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; misty-lavender-theme.el ends here
